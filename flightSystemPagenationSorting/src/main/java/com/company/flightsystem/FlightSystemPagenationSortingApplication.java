...
//public class FlightSystemPagenationSortingApplication {
//
//    public static void main(String[] args) {
//        SpringApplication.run(FlightSystemPagenationSortingApplication.class, args);
//    }
//
//}
package com.company.flightsystem;
...
public class FlightSystemPagenationSortingApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(
                FlightSystemPagenationSortingApplication.class,
                args);
    }
